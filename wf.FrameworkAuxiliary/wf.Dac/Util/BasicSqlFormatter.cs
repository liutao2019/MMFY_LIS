...
namespace Lib.DAC
{
    ...
    /// sql语句格式格式化类
    /// </summary>
    internal class BasicSqlFormatter //: IFormatter
    {
        protected const string IndentString = "    ";
        protected const string Initial = "";
        //protected const string Initial = "\n    ";
        //protected const string Initial = "\n";
        protected static readonly List<string> beginClauses = new List<string>();
        protected static readonly List<string> dml = new List<string>();
        protected static readonly List<string> endClauses = new List<string>();
        protected static readonly List<string> logical = new List<string>();
        protected static readonly List<string> misc = new List<string>();
        protected static readonly List<string> quantifiers = new List<string>();

        static BasicSqlFormatter()
        {
        ...
        private class FormatProcess
        {
            ...
            public FormatProcess(string sql)
            {
                ...
                tokens = new StringTokenizer(sql, "()+*/-=<>'`\"[],;" + SqlStringConst.WhiteSpace, true).GetEnumerator();
            }
            ...
            {
                return SqlStringConst.WhiteSpace.IndexOf(token) >= 0;
            }
