...
{
    public class TelPhonePatientInterface : IPatientInterface<InterfacePatientInfo>
    {
...
where patients_newborn.pat_tel='{0}' order by patients_newborn.pat_flag desc ", code);
