...
{
    public interface IDaoReaStoreCount:IDaoBase
    {
        List<EntityReaStoreCount> SearchAll();
        bool UpdateReaStoreCount(EntityReaStoreCount reaStoreCount);

        EntityResponse SaveReaStoreCount(EntityReaStoreCount reaStoreCount);
        List<EntityReaStoreCount> SearchByQC(EntityReaQC reaQC);
    }
}
