...
{
    public interface IDaoReaPurchase: IDaoBase
    {
        string GetReaSID_MaxPlusOne(DateTime date, string stepCode);
        bool ExsitSidOrHostOrder(string rea_sid, DateTime rea_in_date);
        bool InsertNewReaPurchase(EntityReaPurchase purchase);
        List<EntityReaPurchase> QueryPurchaseList(EntityReaQC reaQC);
        bool UpdateReaPurchaseData(EntityReaPurchase reaPurchase);
        bool DeleteReaPurchaseData(EntityReaPurchase reaPurchase);
        bool ReturnReaPurchaseData(EntityReaPurchase reaPurchase);
        void UpdatePurchaseStatus(string rayNo, string printId, DateTime date);
