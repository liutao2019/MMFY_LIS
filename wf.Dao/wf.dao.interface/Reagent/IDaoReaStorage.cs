...
{
    public interface IDaoReaStorage: IDaoBase
    {
        ...
        bool ExsitBarcodeOrHostOrder(string rea_sid, DateTime rea_in_date);
        bool InsertNewReaStorage(EntityReaStorage Storage);
        List<EntityReaStorage> QueryStorageList(EntityReaQC reaQC);
        bool UpdateReaStorageData(EntityReaStorage reaStorage);
        bool DeleteReaStorageData(EntityReaStorage reaStorage);
        void UpdateStorageStatus(string rayNo, string printId, DateTime date);
        bool ReturnReaStorageData(EntityReaStorage reaStorage);
        bool UpdateOutStorageData(string rsrNo);
    }
}
