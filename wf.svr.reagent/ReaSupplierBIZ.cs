...
{
    public class ReaSupplierBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaSupplier sample = request.GetRequestValue<EntityDicReaSupplier>();
                IDaoDic<EntityDicReaSupplier> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaSupplier>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaSupplier reaSupplier = request.GetRequestValue<EntityDicReaSupplier>();
                reaSupplier.del_flag = "1";
                IDaoDic<EntityDicReaSupplier> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaSupplier>>();
                if (dao == null)
                {
                    response.Scusess = false;
                ...
                {
                    response.Scusess = dao.Update(reaSupplier);
                }
            }
            else
            {
