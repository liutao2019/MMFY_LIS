...
{
    public class ReaProductBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaProduct sample = request.GetRequestValue<EntityDicReaProduct>();
                IDaoDic<EntityDicReaProduct> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaProduct>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaProduct reaUnit = request.GetRequestValue<EntityDicReaProduct>();
                reaUnit.del_flag = "1";
                IDaoDic<EntityDicReaProduct> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaProduct>>();
                if (dao == null)
                {
