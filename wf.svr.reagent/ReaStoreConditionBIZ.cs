...
{
    public class ReaStoreConditionBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaStoreCondition sample = request.GetRequestValue<EntityDicReaStoreCondition>();
                IDaoDic<EntityDicReaStoreCondition> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaStoreCondition>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaStoreCondition reaStoreCondition = request.GetRequestValue<EntityDicReaStoreCondition>();
                reaStoreCondition.del_flag = "1";
                IDaoDic<EntityDicReaStoreCondition> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaStoreCondition>>();
                if (dao == null)
                {
                    response.Scusess = false;
                ...
                {
                    response.Scusess = dao.Update(reaStoreCondition);
                }
            }
            else
            {
