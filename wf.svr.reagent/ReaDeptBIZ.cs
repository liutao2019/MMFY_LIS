...
{
    public class ReaDeptBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaDept sample = request.GetRequestValue<EntityDicReaDept>();
                IDaoDic<EntityDicReaDept> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaDept>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaDept reaDept = request.GetRequestValue<EntityDicReaDept>();
                reaDept.del_flag = "1";
                IDaoDic<EntityDicReaDept> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaDept>>();
                if (dao == null)
                {
                ...
                {
                    response.Scusess = dao.Update(reaDept);
                }
            }
            else
            {
