...
{
    public class ReaGroupBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaGroup sample = request.GetRequestValue<EntityDicReaGroup>();
                IDaoDic<EntityDicReaGroup> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaGroup>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicReaGroup reaGroup = request.GetRequestValue<EntityDicReaGroup>();
                reaGroup.del_flag = "1";
                IDaoDic<EntityDicReaGroup> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicReaGroup>>();
                if (dao == null)
                {
                ...
                {
                    response.Scusess = dao.Update(reaGroup);
                }
            }
            else
            {
