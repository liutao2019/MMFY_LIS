...
namespace wf.client.reagent
{
    ...
    /// 添加组合的选择框
    /// </summary>
    public partial class FrmReagentManagerV2 : FrmCommon
    {
        ...
        public FrmReagentManagerV2()
        {
            InitializeComponent();
        }

        public void SetFilterParam(ReagentFilterParam param)
        {
            Param = param;
        ...
        public FrmReagentManagerV2(ReagentFilterParam param)
        {
            InitializeComponent();
        ...
        private void FrmReagentManagerV2_Leave(object sender, EventArgs e)
        {

        }

        private void FrmReagentManagerV2_Deactivate(object sender, EventArgs e)
        {
            this.Visible = false;
            //this.Close();
        }

        private void FrmReagentManagerV2_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Visible = false;
        }

        private void FrmReagentManagerV2_VisibleChanged(object sender, EventArgs e)
        {
    ...
    /// 组合过滤参数
    /// </summary>
    public class ReagentFilterParam
    {
