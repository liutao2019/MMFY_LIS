...
{
    partial class FrmReagentManagerV2
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmReagentManagerV2));
            ...
            this.Name = "FrmReagentManagerV2";
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "组合选择";
            this.TopMost = true;
            this.Deactivate += new System.EventHandler(this.FrmReagentManagerV2_Deactivate);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FrmReagentManagerV2_FormClosing);
            this.Load += new System.EventHandler(this.FrmReagentSelect_Load);
            this.VisibleChanged += new System.EventHandler(this.FrmReagentManagerV2_VisibleChanged);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FrmReagentSelect_KeyDown);
            this.Leave += new System.EventHandler(this.FrmReagentManagerV2_Leave);
