...
{
    public partial class RoundStorageGroup : XtraUserControl
    {
        //定义委托
        public delegate void PanelGroupHandle(object sender, EventArgs e);
        //定义事件
        public event PanelGroupHandle RoundStorageGroupClick;

        private RoundPanel curRoundPanel;

        public RoundStorageGroup()
        {
            InitializeComponent();
            Load += RoundStorageGroup_Load;
        ...
        private void RoundStorageGroup_Load(object sender, EventArgs e)
        {
        ...
        private void RoundPanel_Click(object sender, EventArgs e)
        {
            ...
            RoundStorageGroupClick?.Invoke(sender, e);
        }
