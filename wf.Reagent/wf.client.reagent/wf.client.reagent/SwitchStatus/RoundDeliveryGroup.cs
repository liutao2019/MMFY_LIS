...
{
    public partial class RoundDeliveryGroup : XtraUserControl
    {
        //定义委托
        public delegate void PanelGroupHandle(object sender, EventArgs e);
        //定义事件
        public event PanelGroupHandle RoundDeliveryGroupClick;

        private RoundPanel curRoundPanel;

        public RoundDeliveryGroup()
        {
            InitializeComponent();
            Load += RoundDeliveryGroup_Load;
        ...
        private void RoundDeliveryGroup_Load(object sender, EventArgs e)
        {
        ...
        private void RoundPanel_Click(object sender, EventArgs e)
        {
            ...
            RoundDeliveryGroupClick?.Invoke(sender, e);
        }
