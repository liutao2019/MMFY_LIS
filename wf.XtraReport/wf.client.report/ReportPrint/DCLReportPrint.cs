...
namespace dcl.client.report
{
    ...
    /// 打印报告类
    /// </summary>
    public class DCLReportPrint
    {
        /// <summary>
        /// 打印配置参数
        /// </summary>
        private static string xmlFile = PathManager.SettingLisPath + @"printXml\printConfig.xml";
        ...
        /// <param name="reportCode"></param>
        /// <param name="listBarCode"></param>
        public static void PrintReaBarCode(String reportCode, List<String> listSampSn, string printName = "")
        {
            if (!string.IsNullOrEmpty(reportCode) && listSampSn.Count > 0)
            {
                EntityDCLPrintParameter printPara = new EntityDCLPrintParameter();
                printPara.ReportCode = reportCode;
                printPara.ListReagentBarId = listSampSn;
                XtraReport xr = CreateReport(printPara, printName);
                xr.Print();
            }
        }
        ...
        public static void BatchPrint(List<EntityDCLPrintParameter> lisParameter, String printName = "")
        {
            ...
            foreach (EntityDCLPrintParameter item in lisParameter)
            {
                ...
                if (xr != null)
                {
                    ...
                    mainReport.PrintingSystem.PageSettings.PrinterName = ReportSetting.PrintName;
                    mainReport.PrinterName = ReportSetting.PrintName;
        ...
        public static void ContinuousPrint(List<EntityDCLPrintParameter> lisParameter, String printName = "")
        {
            ...
            string reportPath = PathManager.ReportPath + "ContinuousPrinting.repx";
            XtraReport mainReport = new XtraReport();
        ...
        private static XtraReport CreateReport(EntityDCLPrintData printData, String printName = "")
        {
            ...
            if (!string.IsNullOrEmpty(printData.ReportName))
            {
                ...
                string reportPath = PathManager.ReportPath + printData.ReportName + CustomReportSuffix + printData.ReportSuffix;
        ...
        private static XtraReport CreatePictureReport(EntityDCLPrintParameter parameter, String printName)
        {
            ...
            if (i > -1)
            {
                ...
                string reportPath = PathManager.ReportPath + listPrintData[i].ReportName + CustomReportSuffix + listPrintData[i].ReportSuffix;
                ...
                if (resIndex > -1)
                {
                    ...
                    string resAddress = PathManager.ReportPath + listPrintData[resIndex].ReportName + CustomReportSuffix + listPrintData[resIndex].ReportSuffix;
                ...
                if (picIndex > -1)
                {
                    ...
                    string resAddress = PathManager.ReportPath + listPrintData[picIndex].ReportName + CustomReportSuffix + listPrintData[picIndex].ReportSuffix;
        ...
        private static XtraReport CreateNestReport(EntityDCLPrintParameter parameter, String printName)
        {
            ...
            foreach (EntitySysReport report in listNextReport)
            {
                ...
                if (subControl != null)
                {
                    ...
                    string subReportPath = PathManager.ReportPath + subPrintData.ReportName + CustomReportSuffix + subPrintData.ReportSuffix;
