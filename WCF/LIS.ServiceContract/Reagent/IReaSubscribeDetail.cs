...
{
    [ServiceContract]
    public interface IReaSubscribeDetail
    {
        [OperationContract]
        bool InsertNewDetail(List<EntityReaSubscribeDetail> repDetails);
        [OperationContract]
        List<EntityReaSubscribeDetail> GetDetail(EntityReaQC qc);
        [OperationContract]
