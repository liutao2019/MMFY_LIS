...
{
    [ServiceContract]
    public interface IReaApplyDetail
    {
        [OperationContract]
        bool DeleteReaApplyDetail(string repId);
        [OperationContract]
        bool InsertNewReaApplyDetail(List<EntityReaApplyDetail> repDetails);
        [OperationContract]
        List<EntityReaApplyDetail> GetReaApplyDetailByReaId(string reaId);
        [OperationContract]
        bool DeleteCommonDetailByReaId(EntityLogLogin logLogin, string reaId, string rayNo);
    }
}
