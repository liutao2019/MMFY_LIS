...
{
    [ServiceContract]
    public interface IReaLossReportDetail
    {
        [OperationContract]
        bool InsertNewDetail(List<EntityReaLossReportDetail> repDetails);
        [OperationContract]
        List<EntityReaLossReportDetail> GetDetail(EntityReaQC qc);
        [OperationContract]
        bool DeleteCommonDetail(EntityLogLogin logLogin, EntityReaQC qc);
        [OperationContract]
