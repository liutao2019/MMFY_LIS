<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmReportSelectNw.aspx.cs" 
EnableEventValidation="false" Inherits="dcl.pub.wcf.web.FrmReportSelectNw" %>
...
//    }
    ...
    function SampleClick(source , eventArgs){
    ...
    function CombineClick(source , eventArgs){

     document.getElementById(('txtCombine')).value="";
     document.getElementById(('txtCombine')).focus();
...
<body style="text-align: center; margin: 0 0 0 0;">
    <form id="form1" runat="server">
        <a runat="server"  id="link1" href="javascript:CheckIsInstall()">查看本机是否安装打印控件</a>
            ...
            <table style="width: 100%;">
                        ...
                        <table style="width: 100%" id="tbSearchbar" runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label id="a" onclick="DeptClick()" class="button" style="font-size: 16px">
                                        ▼</label>
                                </td>
                                <td class="td3-ttl" style="width: 50px">
                            ...
                            <tr>
                            <td align="right"> <asp:Label ID="Label3" runat="server" Text="性别" Width="30px"></asp:Label></td>
                            <td>
                            ...
                            <td align="right"> <asp:Label ID="Label7" runat="server" Text="床号" Width="30px"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtPatBed" runat="server"></asp:TextBox>
                            </td>
                            <td align="right"> <asp:Label ID="Label8" runat="server" Text="标本类别" Width="50px"></asp:Label></td>
                            <td>
                            <asp:TextBox ID="txtSample" runat="server" Width="160" 
                                        AutoCompleteType="Disabled"></asp:TextBox>
                                    <cc3:AutoCompleteExtender ID="txtSample_AutoCompleteExtender" runat="server" 
                                      FirstRowSelected="true" CompletionInterval="100" CompletionSetCount="12" EnableCaching="true" 
                                        MinimumPrefixLength="0" OnClientItemSelected="SetSample" 
                                        ServiceMethod="GetSample" ServicePath="AutoCompleteDict.asmx" 
                                        TargetControlID="txtSample" CompletionListCssClass="autocomplete_completionListElement"
                                        CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc3:AutoCompleteExtender>
                                    <label id="lblSample" onclick="SampleClick()" class="button" style="font-size: 16px">
                                        ▼</label>
                            </td>
                            <td align="right"> <asp:Label ID="Label9" runat="server" Text="组合项目" Width="50px"></asp:Label></td>
                            <td>
                            <asp:TextBox ID="txtCombine" runat="server" Width="160" 
                                        AutoCompleteType="Disabled"></asp:TextBox>
                                    <cc3:AutoCompleteExtender ID="txtCombine_AutoCompleteExtender" runat="server" 
                                       FirstRowSelected="true" CompletionInterval="100" CompletionSetCount="12" EnableCaching="true" 
                                        MinimumPrefixLength="0" OnClientItemSelected="SetCombine" 
                                        ServiceMethod="GetCombine" ServicePath="AutoCompleteDict.asmx" 
                                        TargetControlID="txtCombine" CompletionListCssClass="autocomplete_completionListElement"
                                        CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                    </cc3:AutoCompleteExtender>
                                    <label id="lblCombine" onclick="CombineClick()" class="button" style="font-size: 16px">
                                        ▼</label>
                            </td>
                            </tr>
                            <tr>
                            <td align="right"> <asp:Label ID="Label10" runat="server" Text="临床诊断" Width="50px"></asp:Label></td>
                            <td>
                ...
                <tr>
                    <td style="width: 30%" valign="top" id="tdLeft" runat="server">
				     ...
				     <asp:BoundField DataField="pat_itr_id" HeaderText="pat_itr_id" ReadOnly="True">
                                        <HeaderStyle Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
