...
namespace dcl.client.common
{
    ...
    /// <code>
    /// 
    /// using wf.client.common;
    ///  
    ///   internal GridCheckSelection Selection { get; private set; }
    ///   
    ///    private void Form1_Load(object sender, System.EventArgs e)
    ///    { 
    ///       MainGridView.ExpandAllGroups();
    ///       Selection = new GridCheckSelection(MainGridView);
    ...
    public class GridCheckSelection
    {
        ...
        public GridCheckSelection()
            : base()
        {
            selection = new ArrayList();
        }

        public GridCheckSelection(GridView view)
            : this()
        {
            View = view;
        }
        ...
        private void View_Click(object sender, EventArgs e)
        {
            ...
            if (info.InColumn && info.Column == column)
            {
                ...
                OnCheckMarksColumnClick(sender, new CheckColumnClickEventArgs(-1, check));
            }
        ...
        private void view_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Clicks == 1 && e.Button == MouseButtons.Left)
            {
                ...
                //        OnCheckMarksColumnClick(sender, new CheckColumnClickEventArgs(info.RowHandle, true));
                //    }
                //}
        ...
        public List<EntityReaStorageDetail> GetAllSelectSamp()
        {
            List<EntityReaStorageDetail> listSamp = new List<EntityReaStorageDetail>();
            for (int i = 0; i < selection.Count; i++)
            {
                listSamp.Add((EntityReaStorageDetail)selection[i]);
            }
            return listSamp;
        }

        public List<T> GetAllSelectT<T>() where T:new()
        {
            List<T> listSamp = new List<T>();
            for (int i = 0; i < selection.Count; i++)
            {
                listSamp.Add((T)selection[i]);
            }
            return listSamp;
        }
        ...
        public int GetSelectedIndex(object row)
        {
            for (int i = 0; i < selection.Count; i++)
            {
                if (((EntityReaStorageDetail)selection[i]).Rsd_barcode == ((EntityReaStorageDetail)row).Rsd_barcode)
                {
                    return i;
                }
            }
        ...
        public void ClearSelection()
        {
            ...
            {
                EntityReaStorageDetail sm = (EntityReaStorageDetail)view.GetRow(i);
                if (sm != null)
        ...
        private void view_CustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            if (e.Column == CheckMarkColumn)
            {
                ...
                else
                {
                    ...
                    //OnCheckMarksColumnClick(sender, new CheckColumnClickEventArgs(index, check));
                }
            }
        }
        ...
        private void edit_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (view.GetFocusedRow() != null)
            {
                ...
                if (ck.Checked)
                {
                    EntityReaStorageDetail samp = view.GetFocusedRow() as EntityReaStorageDetail;
        ...
        public event CheckEventHandler CheckMarksColumnClick;
        public void OnCheckMarksColumnClick(object sender, CheckColumnClickEventArgs e)
        {
    ...
    public delegate void CheckEventHandler(object sender, CheckColumnClickEventArgs e);

    public class CheckColumnClickEventArgs : EventArgs
    {
        /// <summary>
        ...
        public CheckColumnClickEventArgs(int rowHandle, bool isChecked)
        {
