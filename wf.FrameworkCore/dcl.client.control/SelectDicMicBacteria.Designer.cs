...
{
    partial class SelectDicMicBacteria
    {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
            ...
            // bsSource
            // 
            this.bsSource.DataSource = typeof(dcl.entity.EntityDicMicBacteria);
            // 
            // gridControl2
            // 
            ...
            // colbt_cname
            // 
            this.colbt_cname.Caption = "细菌名称";
            this.colbt_cname.FieldName = "BacCname";
            ...
            this.colValue = "";
            this.colWB = "";
            this.DataBindings.Add(new System.Windows.Forms.Binding("colDisplay", this.bsSource, "BacCname", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colInCode", this.bsSource, "BacCCode", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colPY", this.bsSource, "BacPyCode", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colSeq", this.bsSource, "BacId", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colValue", this.bsSource, "BacId", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colWB", this.bsSource, "BacWbCode", true));
            this.Name = "SelectDicMicBacteria";
