...
{
  partial class SelectDicReaDept
    {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
            ...
            // bsSource
            // 
            this.bsSource.DataSource = typeof(dcl.entity.EntityDicReaDept);
            // 
            // gridControl2
            // 
            ...
            // coldept_name
            // 
            this.coldept_name.Caption = "认领部门";
            this.coldept_name.FieldName = "Rclaim_Dept";
            ...
            this.coldept_id.FieldName = "Rdept_id";
            ...
            this.DataBindings.Add(new System.Windows.Forms.Binding("colDisplay", this.bsSource, "Rclaim_Dept", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colExtend1", this.bsSource, "py_code", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colValue", this.bsSource, "Rdept_id", true));
            this.Name = "SelectDicReaDept";
