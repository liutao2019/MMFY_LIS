...
{
  partial class SelectDicReaStorePosition
    {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
            ...
            this.colstr_position_name = new DevExpress.XtraGrid.Columns.GridColumn();
            this.colstr_position_id = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            // bsSource
            // 
            this.bsSource.DataSource = typeof(dcl.entity.EntityDicReaStorePos);
            // 
            // gridControl2
            // 
            ...
            this.colstr_position_name,
            this.colstr_position_id,
            this.colpy_ccode,
            this.colpy_code,
            this.colwb_code,
            this.gridColumn1});
            ...
            // 
            // colstr_position_name
            // 
            this.colstr_position_name.Caption = "存储位置";
            this.colstr_position_name.FieldName = "Rstr_position";
            this.colstr_position_name.Name = "colstr_position_name";
            this.colstr_position_name.OptionsColumn.AllowEdit = false;
            this.colstr_position_name.Visible = true;
            this.colstr_position_name.VisibleIndex = 1;
            this.colstr_position_name.Width = 85;
            // 
            // colstr_position_id
            // 
            this.colstr_position_id.Caption = "代码";
            this.colstr_position_id.FieldName = "Rstr_position_id";
            this.colstr_position_id.Name = "colstr_position_id";
            this.colstr_position_id.OptionsColumn.AllowEdit = false;
            this.colstr_position_id.Visible = true;
            this.colstr_position_id.VisibleIndex = 0;
            // 
            // colpy_ccode
            // 
            ...
            this.DataBindings.Add(new System.Windows.Forms.Binding("colDisplay", this.bsSource, "Rstr_position", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colExtend1", this.bsSource, "py_code", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colValue", this.bsSource, "Rstr_position_id", true));
            this.Name = "SelectDicReaStorePosition";
    ...
    private DevExpress.XtraGrid.Columns.GridColumn colstr_position_name;
    private DevExpress.XtraGrid.Columns.GridColumn colstr_position_id;
