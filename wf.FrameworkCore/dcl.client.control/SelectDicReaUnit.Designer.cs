...
{
  partial class SelectDicReaUnit
    {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
            ...
            // bsSource
            // 
            this.bsSource.DataSource = typeof(dcl.entity.EntityDicReaUnit);
            // 
            // gridControl2
            // 
            ...
            // colunit_name
            // 
            this.colunit_name.Caption = "单位名称";
            this.colunit_name.FieldName = "Runit_name";
            ...
            this.colunit_name.Width = 85;
            // 
            // colunit_id
            // 
            this.colunit_id.Caption = "代码";
            this.colunit_id.FieldName = "Runit_id";
            ...
            this.DataBindings.Add(new System.Windows.Forms.Binding("colInCode", this.bsSource, "Runit_id", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colDisplay", this.bsSource, "Runit_name", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colExtend1", this.bsSource, "py_code", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colValue", this.bsSource, "Runit_id", true));
            this.Name = "SelectDicReaUnit";
