...
{
  partial class SelectDicReaProduct
    {
    /// <summary>
    /// 必需的设计器变量。
    /// </summary>
    ...
    private void InitializeComponent()
    {
            ...
            this.colpdt_name = new DevExpress.XtraGrid.Columns.GridColumn();
            this.colpdt_id = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            // bsSource
            // 
            this.bsSource.DataSource = typeof(dcl.entity.EntityDicReaProduct);
            // 
            // gridControl2
            // 
            ...
            // colpdt_name
            // 
            this.colpdt_name.Caption = "生产厂商";
            this.colpdt_name.FieldName = "Rpdt_name";
            this.colpdt_name.Name = "colpdt_name";
            this.colpdt_name.OptionsColumn.AllowEdit = false;
            this.colpdt_name.Visible = true;
            this.colpdt_name.VisibleIndex = 1;
            this.colpdt_name.Width = 85;
            // 
            // colpdt_id
            // 
            this.colpdt_id.Caption = "代码";
            this.colpdt_id.FieldName = "Rpdt_id";
            this.colpdt_id.Name = "colpdt_id";
            this.colpdt_id.OptionsColumn.AllowEdit = false;
            this.colpdt_id.Visible = true;
            this.colpdt_id.VisibleIndex = 0;
            // 
            // colpy_ccode
            // 
            ...
            this.DataBindings.Add(new System.Windows.Forms.Binding("colDisplay", this.bsSource, "Rpdt_name", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colExtend1", this.bsSource, "py_code", true));
            this.DataBindings.Add(new System.Windows.Forms.Binding("colValue", this.bsSource, "Rpdt_id", true));
            this.Name = "SelectDicReaProduct";
    ...
    private DevExpress.XtraGrid.Columns.GridColumn colpdt_name;
    private DevExpress.XtraGrid.Columns.GridColumn colpdt_id;
