...
{
    public partial class SelectDicReaReturn : DclPopSelect<EntityDicReaReturn>
    {

        public SelectDicReaReturn()
        {
        ...
        public override List<EntityDicReaReturn> getDataSource()
        {
            return CacheClient.GetCache<EntityDicReaReturn>();
        }
