...
namespace dcl.client.notifyclient
{
    public partial class FrmReadAffirm2 : Form
    {
        ...
        public FrmReadAffirm2()
        {
            ...
            //临床工号过滤事件
            this.txtdoc_num.SetFilter(this.txtdoc_num.getDataSource().FindAll(w => w.UserType =="检验组"));
        }
        ...
        private void btnAffirm_Click(object sender, EventArgs e)
        {
            ...
            userInfo.MsgDocNum = (string.IsNullOrEmpty(this.txtdoc_num.Text.Trim()) ? this.txtdoc_num.valueMember : this.txtdoc_num.Text.Trim());//临床工号
        ...
        private void txtdoc_num_ValueChanged(object sender, control.ValueChangeEventArgs args)
        {
            this.txtdoc_name.Text = this.txtdoc_num.displayMember;
            this.txtdoc_num.displayMember = this.txtdoc_num.valueMember;
        }
