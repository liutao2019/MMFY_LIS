...
{
    public class HospitalBIZ : IDicCommon
    {
        ...
        public EntityResponse New(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicPubOrganize sample = request.GetRequestValue<EntityDicPubOrganize>();
                IDaoDic<EntityDicPubOrganize> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicPubOrganize>>();
                if (dao == null)
                {
        ...
        public EntityResponse Delete(EntityRequest request)
        {
            ...
            if (request != null)
            {
                EntityDicPubOrganize pubOrganize = request.GetRequestValue<EntityDicPubOrganize>();
                pubOrganize.OrgDelFlag = "1";
                IDaoDic<EntityDicPubOrganize> dao = DclDaoFactory.DaoHandler<IDaoDic<EntityDicPubOrganize>>();
                if (dao == null)
                {
                    response.Scusess = false;
                ...
                {
                    response.Scusess = dao.Update(pubOrganize);
                }
            }
            else
            {
